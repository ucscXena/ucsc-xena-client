...
// XXX All this is deprecated. We need to rework getColSpec
// and the column add code before dropping the rest of this.
...
function fetchComposite(column, samples) {
	return fieldFetch(column.fieldSpecs[0], samples);
}
